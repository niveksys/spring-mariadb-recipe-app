...
create table receipt_category (recipe_id bigint not null, category_id bigint not null, primary key (recipe_id, category_id)) engine=InnoDB;
...
alter table receipt_category add constraint FKlun7hpd6s35re40o36va1xc5f foreign key (recipe_id) references recipe (id);
